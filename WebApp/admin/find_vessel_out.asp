...
<form method="post" action="vessel_out_2.asp">
                                  ...
                                  <tr> 
                                    <td> 
                                      <table width="100%" border="0" cellspacing="0" cellpadding="3">
                                        <tr> 
                                          <td width="77%"> 
                                            <input type="text" name="form_cfv" maxlength="10">
                                          </td>
                                        </tr>
                                      </table>
                                    </td>
...
SQL = "VesselGetInactive"
set rs = openConnection.Execute (SQL, 4)

if rs.eof and rs.bof then 

response.write "</select><BR><span class='copy_sm_bold_bl'>There are no vessels.</span>"
